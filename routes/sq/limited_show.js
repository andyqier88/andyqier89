                    ...
                    request.get({ url: 'https://api.weixin.qq.com/cgi-bin/user/info?access_token=' + access_token + '&openid=' + openid + '&lang=zh_CN' },
                            function(error, response, body) {
                                ...
                                if (response.statusCode == 200 || response.statusCode == 304) {
                                    ...
                                    console.log(postUrl);
                                    request.get({
                                                url: postUrl+"?specialId="+specialId+"&unionid="+unionid+"&shareUserId="+shareUserId,json: true
                                            },
                                            function(error, response, body) {
                                                var dataApi = body;
                                                console.log(dataApi)
                                                ...
                                                req.session.show_session = show_session;
                                                    res.render('limited_show', { params, arttalkId, unionid, apiUrl, subscribe, dataApi });
